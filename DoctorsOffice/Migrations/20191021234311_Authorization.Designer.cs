...
namespace DoctorsOffice.Migrations
{
    ...
    [Migration("20191021234311_Authorization")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorsOffice.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DoctorsOffice.Models.Patient", b =>
                {
                    b.HasOne("DoctorsOffice.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DoctorsOffice.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
